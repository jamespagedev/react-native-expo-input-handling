...
export const backendServerUri =
  process.env.REACT_APP_NODE_ENV === "development"
    ? process.env.REACT_APP_LOCAL_DEV_HOM_API
    : process.env.REACT_APP_NODE_ENV === "test"
    ? process.env.REACT_APP_QA_HOM_API
    : process.env.REACT_APP_PROD_HOM_API
*/

const backendServerUri = "http://localhost:5003/api/";
